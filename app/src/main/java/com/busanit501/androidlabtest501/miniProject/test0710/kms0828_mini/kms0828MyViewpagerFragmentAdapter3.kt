...
class kms0828MyViewpagerFragmentAdapter3(fragmentActivity: FragmentActivity) : FragmentStateAdapter(fragmentActivity) {
    ...
    init {
        ...
        sampleFragmentList = mutableListOf(kms0828Ch11Fragment1(), kms0828Ch11Fragment3())
