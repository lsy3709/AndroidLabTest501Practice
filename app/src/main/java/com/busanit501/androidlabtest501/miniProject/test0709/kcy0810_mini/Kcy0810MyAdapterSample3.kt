...
class Kcy0810MyAdapterSample3(val datas: MutableList<String> ) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    // 어댑터에 뷰홀더 연결하기.
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder  =
        Kcy0810MyViewHolder3(Kcy0810ItemSimpleRecycler3Binding.inflate(LayoutInflater.from(parent.context),parent, false))
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val binding = (holder as Kcy0810MyViewHolder3).binding
        // 더미 데이터로 , food2 같은 이미지로 재사용.
//        binding.ch11RecyclerItemImg =
        // 더미 데이터로, 문자열만, 내가 정한 임의의 데이터를 넣기.
        binding.kcy0810Recycler3ItemTextView.text = datas[position]
