...
import com.busanit501.androidlabtest501.databinding.FragmentKms08281Binding


class kms0828Ch11Fragment1 : Fragment() {

    // 순서2, 프래그먼트 만들기. 뼈대 샘플 코딩 많이 지움.

    lateinit var binding:FragmentKms08281Binding
    ...
    override fun onCreateView(
        ...
        savedInstanceState: Bundle?
          ...
          binding = FragmentKms08281Binding.inflate(layoutInflater,container,false)
