...
import com.busanit501.androidlabtest501.databinding.FragmentKcy0810OneBinding


class Kcy0810Fragment1 : Fragment() {

    // 순서2, 프래그먼트 만들기. 뼈대 샘플 코딩 많이 지움.

    lateinit var binding:FragmentKcy0810OneBinding
    ...
    override fun onCreateView(
        ...
        savedInstanceState: Bundle?
          ...
          binding = FragmentKcy0810OneBinding.inflate(layoutInflater,container,false)
