...
import com.busanit501.androidlabtest501.databinding.OhjFragmentCh113Binding


class ohj_Ch11Fragment3 : Fragment() {

    // 순서2, 프래그먼트 만들기. 뼈대 샘플 코딩 많이 지움.

    lateinit var binding: OhjFragmentCh113Binding
    lateinit var TAG: String

    // 생명주기 확인을 위한, 로그 달기.
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        TAG = "OhjCh11threeFragment"
    ...
    override fun onCreateView(
        ...
        binding = OhjFragmentCh113Binding.inflate(layoutInflater,container,false)
