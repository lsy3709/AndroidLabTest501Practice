package com.busanit501.androidlabtest501.miniProject.test0709.ohj0106_mini
...
import com.busanit501.androidlabtest501.databinding.ActivityOhjCh11MainRecyclerView1Binding

class ohj_Ch11MainRecyclerView1Activity : AppCompatActivity() {
    lateinit var binding: ActivityOhjCh11MainRecyclerView1Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityOhjCh11MainRecyclerView1Binding.inflate(layoutInflater)
...
//        setContentView(R.layout.activity_ch11_main_recycler_view1)
        ...
        val layoutManager = LinearLayoutManager(this@ohj_Ch11MainRecyclerView1Activity)
        ...
        //리사이클러뷰 , 어떤 모양으로 배치할지 정하기.
        // 세로 방향, 가로 방향, 지그재그, 그리드 등.
        val layoutManager2 = LinearLayoutManager(this@ohj_Ch11MainRecyclerView1Activity)
        ...
        for(i in 1..10) {
            datas3.add("오늘도 이겼죠? $i")
        }

        //리사이클러뷰 , 어떤 모양으로 배치할지 정하기.
        // 세로 방향, 가로 방향, 지그재그, 그리드 등.
        val layoutManager3 = LinearLayoutManager(this@ohj_Ch11MainRecyclerView1Activity)
