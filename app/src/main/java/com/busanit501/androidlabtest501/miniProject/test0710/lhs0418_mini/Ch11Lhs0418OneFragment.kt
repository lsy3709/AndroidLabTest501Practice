...
import com.busanit501.androidlabtest501.databinding.FragmentLhs0418Ch11OneBinding


class Ch11Lhs0418OneFragment : Fragment() {

    // 순서2, 프래그먼트 만들기. 뼈대 샘플 코딩 많이 지움.

    lateinit var binding:FragmentLhs0418Ch11OneBinding
    ...
    override fun onCreateView(
        ...
        savedInstanceState: Bundle?
          ...
          binding = FragmentLhs0418Ch11OneBinding.inflate(layoutInflater,container,false)
