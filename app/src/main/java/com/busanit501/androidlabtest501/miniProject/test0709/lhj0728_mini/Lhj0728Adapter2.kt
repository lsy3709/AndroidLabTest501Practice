...
class Lhj0728Adapter2(val datas: MutableList<String> ) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder  =
        Lhj0728ViewHolder2(Lhj0728ItemRecycler2Binding.inflate(LayoutInflater.from(parent.context),parent, false))
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val binding = (holder as Lhj0728ViewHolder2).binding
        binding.Recycler2ItemTextView.text = datas[position]
        binding.lhj0728ItemRoot2.setOnClickListener {
