...
import com.busanit501.androidlabtest501.databinding.FragmentKcy0810ThreeBinding


class Kcy0810Fragment3 : Fragment() {

    // 순서2, 프래그먼트 만들기. 뼈대 샘플 코딩 많이 지움.

    lateinit var binding: FragmentKcy0810ThreeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentKcy0810ThreeBinding.inflate(layoutInflater,container,false)
