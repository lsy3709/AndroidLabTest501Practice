...
import com.busanit501.androidlabtest501.databinding.FragmentLsj09182Binding

class lsj0918Fragment2 : Fragment() {
    // 순서2, 프래그먼트 만들기. 뼈대 샘플 코딩 많이 지움.

    lateinit var binding: FragmentLsj09182Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLsj09182Binding.inflate(layoutInflater,container,false)
