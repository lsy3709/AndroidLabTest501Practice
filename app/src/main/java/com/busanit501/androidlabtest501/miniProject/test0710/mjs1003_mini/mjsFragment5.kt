...
import com.busanit501.androidlabtest501.databinding.FragmentMjs5Binding


class mjsFragment5 : Fragment() {
    lateinit var binding: FragmentMjs5Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMjs5Binding.inflate(layoutInflater,container,false)
