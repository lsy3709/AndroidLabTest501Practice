...
import com.busanit501.androidlabtest501.ch11_jetpack.recyclerview.test1simple.Ch11MyViewHolder__msy0402
...
class Ch11MyAdapterSample(val datas: MutableList<String> ) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
        Ch11MyViewHolder__msy0402(
            Ch11ItemSimpleRecyclerBinding.inflate(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val binding = (holder as Ch11MyViewHolder__msy0402).binding
