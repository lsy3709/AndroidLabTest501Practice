...
import com.busanit501.androidlabtest501.databinding.ActivityCh11MainRecyclerView1CheckBinding

class Ch11MainRecyclerView1Activity_msy0402 : AppCompatActivity() {
    lateinit var binding: ActivityCh11MainRecyclerView1CheckBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityCh11MainRecyclerView1CheckBinding.inflate(layoutInflater)
