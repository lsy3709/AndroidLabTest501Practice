package com.busanit501.androidlabtest501.miniProject.test0709.ksb0109_mini
...
import com.busanit501.androidlabtest501.databinding.ActivityKsb0109Ch11MainRecyclerView1Binding

class Ksb0109Ch11MainRecyclerView1Activity : AppCompatActivity() {
    lateinit var binding: ActivityKsb0109Ch11MainRecyclerView1Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityKsb0109Ch11MainRecyclerView1Binding.inflate(layoutInflater)
...
//        setContentView(R.layout.activity_ch11_main_recycler_view1)
        ...
        val layoutManager = LinearLayoutManager(this@Ksb0109Ch11MainRecyclerView1Activity)
        ...
        //리사이클러뷰 , 어떤 모양으로 배치할지 정하기.
        // 세로 방향, 가로 방향, 지그재그, 그리드 등.
        val layoutManager2 = LinearLayoutManager(this@Ksb0109Ch11MainRecyclerView1Activity)
        ...
        //리사이클러뷰 , 어떤 모양으로 배치할지 정하기.
        // 세로 방향, 가로 방향, 지그재그, 그리드 등.
        val layoutManager3 = LinearLayoutManager(this@Ksb0109Ch11MainRecyclerView1Activity)
        layoutManager3.orientation = LinearLayoutManager.VERTICAL
        binding.ch11RecyclerSample3.layoutManager = layoutManager3

        // 어댑터 붙이기.
        binding.ch11RecyclerSample3.adapter = KsbCh11MyAdapterSample3(datas3)
