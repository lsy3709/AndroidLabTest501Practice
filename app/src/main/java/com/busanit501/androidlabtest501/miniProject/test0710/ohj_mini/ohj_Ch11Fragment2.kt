...
import com.busanit501.androidlabtest501.databinding.OhjFragmentCh112Binding

class ohj_Ch11Fragment2 : Fragment() {

    // 순서2, 프래그먼트 만들기. 뼈대 샘플 코딩 많이 지움.

    lateinit var binding: OhjFragmentCh112Binding
    lateinit var TAG: String

    // 생명주기 확인을 위한, 로그 달기.
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        TAG = "OhjCh11twoFragment"
    ...
    override fun onCreateView(
        ...
        binding = OhjFragmentCh112Binding.inflate(layoutInflater,container,false)
