...
import com.busanit501.androidlabtest501.databinding.Ch11Lhs0418ItemSimpleRecycler3Binding

class Ch11MyAdapterSample3 (val datas: MutableList<String> ) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    // 어댑터에 뷰홀더 연결하기.
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder  =
        Ch11MyViewHolder3(Ch11Lhs0418ItemSimpleRecycler3Binding.inflate(LayoutInflater.from(parent.context),parent, false))
